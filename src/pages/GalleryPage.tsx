          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8 space-y-12">
              <div className="flex items-center gap-4 animate-in fade-in slide-in-from-left-10 duration-1000">
                <div className="px-5 py-2 bg-[#E3242B] text-white text-[10px] font-bold uppercase tracking-widest rounded-tr-2xl rounded-bl-2xl shadow-lg shadow-red-900/40">
                  Galeri Dokumentasi
                </div>
              ...
              <div className="relative space-y-2 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-200">
                  ...
                  <h1 className="text-7xl md:text-[110px] font-black text-white uppercase tracking-tighter leading-none relative z-10">
                    Arsip <br /> 
              ...
              <p className="text-gray-400 font-medium text-sm md:text-base leading-relaxed max-w-xl border-l-4 border-[#E3242B] pl-8 animate-in fade-in duration-1000 delay-500">
        ...
        <div className="max-w-7xl mx-auto">
          {loading ? (
            <div className="py-40 text-center space-y-4">
               ...
               <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">Synchronizing Archive...</p>
            </div>
          ) : (
            <>
                  ...
                  <div key={img.id} className="group cursor-pointer space-y-6" onClick={() => setSelectedImg(img)}>
                    ...
                    <div className="px-2 space-y-2 text-left">
                       <div className="flex items-center gap-3">
                          <span className="text-[8px] font-bold text-[#E3242B] uppercase tracking-widest bg-red-50 px-2 py-0.5 rounded">Verified</span>
          ...
          <div className="relative bg-white w-full max-w-7xl h-[85vh] rounded-[4rem] overflow-hidden shadow-[0_60px_120px_rgba(0,0,0,0.5)] flex flex-col md:flex-row animate-in zoom-in-95 duration-500 border border-white/10">
            ...
            <div className="h-[40%] md:h-full md:flex-1 bg-[#111827] flex items-center justify-center overflow-hidden border-b md:border-b-0 md:border-r border-gray-100 relative">
                ...
                <div className="absolute top-8 left-8">
                    <div className="px-5 py-2 bg-black/40 backdrop-blur-md rounded-xl border border-white/10 text-white text-[10px] font-bold uppercase tracking-widest flex items-center gap-2">
                ...
                <div className="flex-1 overflow-y-auto custom-scrollbar p-10 md:p-12 space-y-12">
                    <div className="space-y-4">
                        <div className="flex items-center gap-3 text-[#E3242B]">
                            <Clock size={14} />
                            <span className="text-[10px] font-bold uppercase tracking-widest">{selectedImg.tanggal}</span>
                        </div>
                    ...
                    <div className="space-y-4 text-left">
                        <p className="text-gray-500 font-medium text-sm md:text-base leading-relaxed text-justify">
                    ...
                    <div className="bg-gray-50 p-8 rounded-[3rem] border border-gray-100 space-y-6 shadow-inner">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-[10px] font-bold text-emerald-800 uppercase tracking-widest">Verified DDP System</span>
                        </div>
